        ...
        <div class="row g-5">
            <div class="col-lg-8">
                <div class="article-card shadow-lg">
                    <img src="<?= $path ?>" class="w-100 main-img" alt="<?= htmlspecialchars($art['judul']) ?> - Portofolio MGL Sticker">
            ...
            <div class="col-lg-4">
                <div class="sidebar-box shadow">
                    ...
                    foreach ($related as $r):
                        ...
                        if (!file_exists($r_path) || empty($r['thumbnail'])) {
                            $r_path = "uploads/gallery/" . $r['thumbnail'];
                        }
                        if (!file_exists($r_path) || empty($r['thumbnail'])) {
                            $r_path = "https://placehold.co/100x100/111/fff?text=MGL";
                        }
                    ?>
